    ...
    <>
          ...
          <div className="rounded-2xl border border-trust/30 bg-trust/5 p-8 space-y-5">
            ...
            <ul className="space-y-3">
              {[
                ...
                "Each new asset can go into its own series — a Protected Series Designation, not a whole new LLC",
              ].map((item) => (
      ...
      <section className="container-wide section-pb">
        <div className="mx-auto max-w-3xl">
          ...
          {/* CTA */}
          <div className="mt-8 lg:mt-10 rounded-3xl border border-accent bg-card p-10 text-center shadow-[0_30px_80px_-30px_rgba(13,46,85,0.2)]">
