    ...
    <div className="space-y-6">
      <header className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground max-w-2xl">
          ...
          agreement preparation.{data.filingPath === "CONVERT" ? "" : " In a member-managed company, the members are also listed in the Articles of Organization; in a manager-managed company they are not."} You can add, remove, or change owners later
