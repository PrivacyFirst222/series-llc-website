...
| A manager becomes incapacitated | s. 605.04072 | 2.7 5.1 | 2.7 5.1 | 2.7 5.1 | 2.8 5.8 | 2.8 5.8 | Incapacity is defined, so the office becomes vacant on a determinate trigger; the member-managed forms have no manager and the Administrative Member's functions revert to a Majority in Interest |
